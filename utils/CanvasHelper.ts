...
export class CanvasHelper {
    ...
    static _instance: CanvasHelper;
    public static getInstance() {
        if(this._instance) {
            return this._instance;
        }
        this._instance = new CanvasHelper()
        return this._instance;
    }
    ...
    saveAsPNG(canvas : HTMLCanvasElement , width : number , height : number, filename: string ){
        return this.savaAsImage(canvas,width,height,"png", filename);
    }

    saveAsJPEG(canvas : HTMLCanvasElement , width : number , height : number, filename: string ){
        return this.savaAsImage(canvas,width,height,"jpeg", filename);
    }

    saveAsGIF(canvas : HTMLCanvasElement , width : number , height : number, filename: string ){
        return this.savaAsImage(canvas,width,height,"gif", filename);
    }

    saveAsBMP(canvas : HTMLCanvasElement , width : number , height : number, filename: string ){
        return this.savaAsImage(canvas,width,height,"bmp", filename);
    }
